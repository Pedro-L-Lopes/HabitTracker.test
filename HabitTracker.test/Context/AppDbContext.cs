...
namespace HabitTracker.test.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HabitWeekDays>()
                .HasKey(hw => hw.Id);
            modelBuilder.Entity<HabitWeekDays>()
                .HasOne(hw => hw.Habit)
            ...
            modelBuilder.Entity<HabitWeekDays>().HasData(
                new HabitWeekDays { Id = 1, HabitId = 1, WeekDay = 1 },
                new HabitWeekDays { Id = 2, HabitId = 1, WeekDay = 2 },
                new HabitWeekDays { Id = 3, HabitId = 1, WeekDay = 3 },
                new HabitWeekDays { Id = 4, HabitId = 2, WeekDay = 3 },
                new HabitWeekDays { Id = 5, HabitId = 2, WeekDay = 4 },
                new HabitWeekDays { Id = 6, HabitId = 2, WeekDay = 5 },
                new HabitWeekDays { Id = 7, HabitId = 3, WeekDay = 1 },
                new HabitWeekDays { Id = 8, HabitId = 3, WeekDay = 2 },
                new HabitWeekDays { Id = 9, HabitId = 3, WeekDay = 3 },
                new HabitWeekDays { Id = 10, HabitId = 3, WeekDay = 4 },
                new HabitWeekDays { Id = 11, HabitId = 3, WeekDay = 5 },
                new HabitWeekDays { Id = 12, HabitId = 4, WeekDay = 1 },
                new HabitWeekDays { Id = 13, HabitId = 4, WeekDay = 2 },
                new HabitWeekDays { Id = 14, HabitId = 5, WeekDay = 4 },
                new HabitWeekDays { Id = 15, HabitId = 5, WeekDay = 5 }
            );
